...
export const test = base.extend<
  { loginPage: LoginPage; coursePage: CoursePage; studentEnrollmentPage: StudentEnrollmentPage; lessonPage: LessonPage; courseSettingsPage: CourseSettingsPage; myLearningPage: MyLearningPage; orgSettingsPage: OrgSettingsPage },
  { resetData: void }
>({

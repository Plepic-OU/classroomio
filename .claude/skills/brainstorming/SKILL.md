...
- Pass the file path as the argument — the skill will select and run the relevant validators automatically
- Do not ask the user for permission first; validation is automatic after every design document is written

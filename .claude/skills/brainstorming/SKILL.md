...
- After writing the design document, immediately invoke the `validate-design-document` skill on the saved file
- Pass the document path as the argument
- Do not ask the user — run it automatically every time a design document is written

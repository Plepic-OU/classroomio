...
**Validation:**
- After writing the design document, immediately invoke the `validate-design-document` skill on the produced file path
- Do not ask the user for permission — run validation automatically every time a design document is written
- Apply auto-apply findings directly to the document; surface conflicts and user-decision items to the user as the final output

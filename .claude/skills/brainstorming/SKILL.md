...
**Validation:**
- After writing the design document, immediately invoke the `validate-design-document` skill using the Skill tool, passing the design document path as the argument
- Wait for validation to complete and all findings to be triaged before proceeding

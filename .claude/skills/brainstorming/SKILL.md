...
**Validation (automatic — do not ask, always run):**
After writing the design document, immediately invoke the `validate-design-document` skill via the Skill tool, passing the document path as the argument. This runs without user prompting — it is part of completing a brainstorming session.

...
**Validation:**
- Immediately after writing the design document, invoke the `/validate-design-document` skill
- Pass the path of the newly written document
- Work through all validator findings with the user before considering the design done

...
**Validation:**
- After writing the design document, immediately invoke the `validate-design-document` skill
- Do not wait for the user to ask — run validation automatically every time a design document is written

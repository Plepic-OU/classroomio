...
**Validation:**
- After writing the design document, immediately invoke the `validate-design-document` skill on the file that was just written
- Do not wait for the user to ask — run validation automatically every time a design document is saved

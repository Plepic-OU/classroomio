---
name: srd-validator-opus
description: General-purpose SRD/design-document validator running on Opus 4.7. Reads a design document, identifies gaps, contradictions, missing detail, over-engineering, scope creep, hand-waving, and untested assumptions. Read-only. Use when comparing validation quality across model tiers.

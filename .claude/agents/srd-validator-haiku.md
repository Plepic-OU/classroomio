---
name: srd-validator-haiku
description: General-purpose SRD/design-document validator running on Haiku 4.5. Reads a design document, identifies gaps, contradictions, missing detail, over-engineering, scope creep, hand-waving, and untested assumptions. Read-only. Use when comparing validation quality across model tiers.

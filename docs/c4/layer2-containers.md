...
C4Container
  ...
  Container(dashboard, "Dashboard", "SvelteKit / Vite port 5173", "Main LMS web app: org management, student learning, course editor")
  Container(api, "API", "Hono / Node.js port 3002", "PDF/video processing, presigned uploads, email sending")
  Container(marketing, "Marketing Site", "SvelteKit port 5174", "Public-facing landing page and blog")

  System_Ext(supabase_db, "Supabase", "PostgreSQL 15 + Auth + Edge Functions - all application data and authentication")

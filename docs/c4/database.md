...
| overview | character varying | YES | 'Welcome to this amazing course 🚀 ':: |
| id | uuid | NO | uuid_generate_v4() |
| created_at | timestamp with time zone | YES | now() |
| updated_at | timestamp with time zone | YES | now() |
| group_id | uuid | YES |  |
...
| metadata | jsonb | NO | '{"goals": "", "description": "", "requi |
...
| customization | json | NO | '{"apps":{"poll":true,"comments":true}," |
...
| fullname | text | NO |  |
| username | text | NO |  |
| avatar_url | text | YES | 'https://pgrest.classroomio.com/storage/ |
| created_at | timestamp with time zone | YES | now() |
| updated_at | timestamp with time zone | YES | now() |
| email | character varying | YES |  |
...
Generated: 2026-03-13T08:21:56Z

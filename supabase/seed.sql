...
INSERT INTO "auth"."users" ("instance_id", "id", "aud", "role", "email", "encrypted_password", "email_confirmed_at", "invited_at", "confirmation_token", "confirmation_sent_at", "recovery_token", "recovery_sent_at", "email_change_token_new", "email_change", "email_change_sent_at", "last_sign_in_at", "raw_app_meta_data", "raw_user_meta_data", "is_super_admin", "created_at", "updated_at", "phone", "phone_confirmed_at", "phone_change", "phone_change_token", "phone_change_sent_at", "email_change_token_current", "email_change_confirm_status", "banned_until", "reauthentication_token", "reauthentication_sent_at", "is_sso_user", "deleted_at") VALUES
	...
	('00000000-0000-0000-0000-000000000000', 'c3d4e5f6-a7b8-4c9d-8e1f-2a3b4c5d6e7f', 'authenticated', 'authenticated', 'noorg@test.com', '$2a$10$dgxySj.k12gDKhLx7X4x6./J.Nzhz7WQrwh5lkjLKwIwWW4o5GJcW', '2024-01-01 00:00:00+00', NULL, '', NULL, '', NULL, '', '', NULL, '2024-01-01 00:00:00+00', '{"provider": "email", "providers": ["email"]}', '{}', NULL, '2024-01-01 00:00:00+00', '2024-01-01 00:00:00+00', NULL, NULL, '', '', NULL, '', 0, NULL, '', NULL, false, NULL);
...
INSERT INTO "auth"."identities" ("provider_id", "user_id", "identity_data", "provider", "last_sign_in_at", "created_at", "updated_at") VALUES
	...
	('c3d4e5f6-a7b8-4c9d-8e1f-2a3b4c5d6e7f', 'c3d4e5f6-a7b8-4c9d-8e1f-2a3b4c5d6e7f', '{"sub": "c3d4e5f6-a7b8-4c9d-8e1f-2a3b4c5d6e7f", "email": "noorg@test.com"}', 'email', '2024-01-01 00:00:00+00', '2024-01-01 00:00:00+00', '2024-01-01 00:00:00+00');
...
INSERT INTO "public"."profile" ("id", "fullname", "username", "avatar_url", "created_at", "updated_at", "email", "can_add_course", "role", "goal", "source", "metadata", "telegram_chat_id", "is_email_verified") VALUES
	...
	('c3d4e5f6-a7b8-4c9d-8e1f-2a3b4c5d6e7f', 'New User', 'noorg1704067200000', 'https://pgrest.classroomio.com/storage/v1/object/public/avatars/avatar.png', '2024-01-01 00:00:00+00', '2024-01-01 00:00:00+00', 'noorg@test.com', true, NULL, NULL, NULL, NULL, NULL, true);

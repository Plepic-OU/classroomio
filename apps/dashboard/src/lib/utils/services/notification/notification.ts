...
export const NOTIFICATION_NAME = {
  ...
  NEWSFEED: 'NEWSFEED',
  STUDENT_WAITLIST_ADDED: 'STUDENT WAITLIST ADDED',
  TEACHER_WAITLIST_NEW: 'TEACHER WAITLIST NEW',
  STUDENT_WAITLIST_APPROVED: 'STUDENT WAITLIST APPROVED',
  TEACHER_COURSE_FULL: 'TEACHER COURSE FULL'
};
...
const NAME_TO_PATH = {
  ...
  [NOTIFICATION_NAME.STUDENT_WAITLIST_ADDED]: '/api/email/course/student_waitlist_added',
  [NOTIFICATION_NAME.TEACHER_WAITLIST_NEW]: '/api/email/course/teacher_waitlist_new',
  [NOTIFICATION_NAME.STUDENT_WAITLIST_APPROVED]: '/api/email/course/student_waitlist_approved',
  [NOTIFICATION_NAME.TEACHER_COURSE_FULL]: '/api/email/course/teacher_course_full'
};

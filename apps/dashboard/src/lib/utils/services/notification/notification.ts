...
export const NOTIFICATION_NAME = {
  ...
  NEWSFEED: 'NEWSFEED',
  STUDENT_WAITLIST_CONFIRMATION: 'STUDENT_WAITLIST_CONFIRMATION',
  TEACHER_WAITLIST_NOTIFICATION: 'TEACHER_WAITLIST_NOTIFICATION',
  STUDENT_WAITLIST_APPROVED: 'STUDENT_WAITLIST_APPROVED'
};
...
const NAME_TO_PATH = {
  ...
  [NOTIFICATION_NAME.STUDENT_WAITLIST_CONFIRMATION]:
    '/api/email/course/student_waitlist_confirmation',
  [NOTIFICATION_NAME.TEACHER_WAITLIST_NOTIFICATION]:
    '/api/email/course/teacher_waitlist_notification',

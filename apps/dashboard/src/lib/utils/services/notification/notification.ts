...
export const NOTIFICATION_NAME = {
  ...
  NEWSFEED: 'NEWSFEED',
  STUDENT_ADDED_TO_WAITLIST: 'STUDENT ADDED TO WAITLIST',
...
const NAME_TO_PATH = {
  ...
  [NOTIFICATION_NAME.STUDENT_ADDED_TO_WAITLIST]: '/api/email/course/waitlist',
  [NOTIFICATION_NAME.TEACHER_STUDENT_WAITLISTED]: '/api/email/course/waitlist',
  [NOTIFICATION_NAME.STUDENT_WAITLIST_APPROVED]: '/api/email/course/waitlist'
};
